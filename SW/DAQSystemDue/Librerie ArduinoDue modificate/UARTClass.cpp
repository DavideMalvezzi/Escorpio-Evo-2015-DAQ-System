...
{
  return (uint32_t)(_rx_buffer->_iSize + _rx_buffer->_iHead - _rx_buffer->_iTail) % _rx_buffer->_iSize ;
}
...
int UARTClass::read( void )
{
  ...
  _rx_buffer->_iTail = (unsigned int)(_rx_buffer->_iTail + 1) % _rx_buffer->_iSize ;
  return uc ;
}
